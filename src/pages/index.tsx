...
const Index = () => {
  ...
  return (
    <Main
      meta={
        <Meta
          title="Jared Young's Portfolio"
          description="Portfolio built with React and Next.js"
        />
      }
    >
      <MainContainer>
          ...
          <div className="pt-24">
            <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
              ...
              <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                ...
                <button className="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transition hover:scale-105 duration-300 ease-in-out">
                  Subscribe
                </button>
              </div>
              {/* <!--Right Col */}
              ...
              <div className="w-full md:w-1/3 p-6 flex flex-col grow shrink">
                ...
                <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                  <div className="flex items-center justify-start">
                    <button className="mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transition hover:scale-105 duration-300 ease-in-out">
                      Action
                    </button>
                  </div>
                </div>
